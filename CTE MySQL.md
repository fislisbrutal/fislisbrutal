...
> top_store - находит магазин с наибольшим числом продаж
> filtered_sales - считает продажи по дням за последний календарный месяц
> 7_by_day - считает 7-дневное скользящее среднее для каждого дня
